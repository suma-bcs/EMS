...
def main():
    ...
    clas=StringVar()
    persent=StringVar()
    Label(win,text="Add New Employee",bg="teal",fg="white",font=("Georgia",16)).place(x=60,y=2)
    ...
    Button(win,text="Add",bg="white",fg="teal",font=("Georgia",9),command=add).pack(anchor="s",side="bottom")
    win.bind("<Key>",press)
    win.mainloop()
